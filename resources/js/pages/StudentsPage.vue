<template>
  <div class="space-y-6">
    ...
    <Teleport to="body">
      ...
      >
        <div class="relative w-full max-w-2xl mx-4 my-8 bg-white dark:bg-[#1a1a18] rounded-lg shadow-xl">
...
const deleteTarget = ref(null); // { type: 'single', row } | { type: 'bulk', ids }
...
const formFields = [
  ...
  { type: 'number', model: 'YearLevel', label: 'Year Level', placeholder: 'e.g. 1', required: false },
  {
    type: 'select',
    model: 'status',
    label: 'Status',
